...
namespace elemental.Items
{
	class WindHook : ModItem
	{
		...
		{
		  DisplayName.SetDefault("Wind Hook");
		  Tooltip.SetDefault("I hope I didn't make a mistake this time...");
		}
	...
	class WindHookProjectile : ModProjectile
	{
		public override void SetDefaults()
		{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			while (distance > 30f && !float.IsNaN(distance))
			{
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Items/WindHookChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
